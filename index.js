// CDN 환경을 위한 React Hook 및 아이콘 선언
const { useState } = React;
const { Sparkles, Camera, ChevronLeft, User, ShoppingBag, ZoomIn, RotateCw, Download } = lucide;
...
function StyleFitApp() {
  ...
  const resetApp = () => {
    setModelImage(null);
    clothImage(null); // 안전하게 가려면 setClothImage(null)이 좋지만 원래 코드를 유지합니다.
